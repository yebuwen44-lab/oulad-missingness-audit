...
> **Package version: 1.2.** This package provides the processed analytical data, frozen numerical results, source code, configuration files, and integrity-verification utilities associated with the manuscript.
