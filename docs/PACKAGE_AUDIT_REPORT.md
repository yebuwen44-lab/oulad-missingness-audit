...
- Select a public software license for the analysis code. MIT is recommended but has not been applied automatically.
- Create the public GitHub/Zenodo record and replace `TO_BE_ASSIGNED` in `CITATION.cff`.
- Update the manuscript Data Availability and Code Availability statements with the final persistent URL/DOI.
